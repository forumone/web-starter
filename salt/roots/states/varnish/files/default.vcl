...
sub vcl_recv {
  ...
  if (req.http.Cookie) {
    ...
    set req.http.Cookie = regsuball(req.http.Cookie, ";(S{1,2}ESS[a-z0-9]+|sails.sid|NO_CACHE|PHPSESS|PHPSESSSID|XDEBUG_[_A-Z]+|cfs_session|wordpress_logged_in_[a-z0-9]+|wordpress_[a-z0-9]+|wordpress_test_cookie|wp-resetpass-[a-z0-9]+)=", "; \1=");
    set req.http.Cookie = regsuball(req.http.Cookie, ";[^ ][^;]*", "");
    set req.http.Cookie = regsuball(req.http.Cookie, "^[; ]+|[; ]+$", "");
